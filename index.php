...
<script type="text/javascript" nonce="XnG4urAXtHXAwmYa4Vp21ZMI">try{if(document.domain!="nid.naver.com"||location.protocol!="https:"){location.href="https://nid.naver.com/login/api/proxy.repo.naver?protocol="+location.protocol+"&domain="+document.domain+"&referrer="+encodeURIComponent(document.referrer)}}catch(e){}</script>
